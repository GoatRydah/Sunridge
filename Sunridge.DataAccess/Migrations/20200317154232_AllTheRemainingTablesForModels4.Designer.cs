...
namespace Sunridge.DataAccess.Migrations
{
    ...
    [Migration("20200317154232_AllTheRemainingTablesForModels4")]
    partial class AllTheRemainingTablesForModels4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sunridge.Models.DbItem", b =>
                {
            ...
            modelBuilder.Entity("Sunridge.Models.ViewModels.ClassifiedListingViewModel", b =>
                {
                    ...
                    b.Property<int?>("ClassifiedListingDbItemId")
                        .HasColumnType("int");

                    b.HasKey("ClassifiedListingViewModelId");

                    b.HasIndex("ClassifiedListingDbItemId");
            ...
            modelBuilder.Entity("Sunridge.Models.ClassifiedCategory", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ClassifiedCategory");
                });
            ...
            modelBuilder.Entity("Sunridge.Models.ClassifiedListing", b =>
                {
                    ...
                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnName("ClassifiedListing_Description")
                    ...
                    b.HasDiscriminator().HasValue("ClassifiedListing");
                });
            ...
            modelBuilder.Entity("Sunridge.Models.CommonAreaAsset", b =>
                {
                    ...
                    b.Property<string>("Description")
                        .HasColumnName("CommonAreaAsset_Description")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasDiscriminator().HasValue("CommonAreaAsset");
                });
            ...
            modelBuilder.Entity("Sunridge.Models.KeyHistory", b =>
                {
                    ...
                    b.Property<int>("KeyId")
                        .HasColumnName("KeyHistory_KeyId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Status")
                        .HasColumnName("KeyHistory_Status")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Sunridge.Models.Maintenance", b =>
                {
                    ...
                    b.Property<int>("CommonAreaAssetId")
                        .HasColumnName("Maintenance_CommonAreaAssetId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sunridge.Models.TransactionType", b =>
                {
                    ...
                    b.Property<string>("Description")
                        .HasColumnName("TransactionType_Description")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Sunridge.Models.ViewModels.ClassifiedListingViewModel", b =>
                {
                    b.HasOne("Sunridge.Models.ClassifiedListing", "ClassifiedListing")
                        .WithMany()
                        .HasForeignKey("ClassifiedListingDbItemId");
                });
